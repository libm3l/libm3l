 ...
 */
	...
	#define FCS_W_ULLI(A,B) snprintf(buff, MAX_WORD_LENGTH,"%"PRIu64 "%c", A, B)
	#define FCS_W_SLLI(A,B) snprintf(buff, MAX_WORD_LENGTH,"%"PRIx64 "%c", A, B)
	#define FCS_W_LLI(A,B)  snprintf(buff, MAX_WORD_LENGTH,"%"PRIx64 "%c", A, B)
	...
	#define FCS_W_SI(A,B)   snprintf(buff, MAX_WORD_LENGTH,"%"PRIx16 "%c",   A, B)
	#define FCS_W_UI(A,B)   snprintf(buff, MAX_WORD_LENGTH,"%"PRIu32 "%c",   A, B)
	#define FCS_W_LI(A,B)   snprintf(buff, MAX_WORD_LENGTH,"%"PRIx64 "%c",  A, B)
	#define FCS_W_I(A,B)    snprintf(buff, MAX_WORD_LENGTH,"%d"PRIx32 "%c",   A, B)

	#define FCS_W_ST(A,B)       snprintf(buff, MAX_WORD_LENGTH,"%" PRIx64 "%c", A, B)
	#define FCS_W_PTRDF(A,B)    snprintf(buff, MAX_WORD_LENGTH,"%" PRIx64 "%c", A, B)
